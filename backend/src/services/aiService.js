...
// verification required, and fast. Runs Llama 3.1 8B, a smaller/faster
// model confirmed available on the free tier (Llama 3.3 70B returned a
// 404 — it appears to require an Enterprise contract now).
//
